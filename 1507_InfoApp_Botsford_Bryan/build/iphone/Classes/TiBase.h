...
// in simulator we redefine to format for MIU1507_Botsford_Bryan_InformationApp Developer console
...
{\
	NSString * exceptionName = [@"org.miu1507_botsford_bryan_informationapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miu1507_botsford_bryan_informationapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemNone = -1, 
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemSpinner = -2,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemProgressBar = -3,
	
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemSlider = -4,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemSwitch = -5,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemMultiButton = -6,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemSegmented = -7,
	
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemTextView = -8,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemTextField = -9,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemSearchBar = -10,
	
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemPicker = -11,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemDatePicker = -12,
	
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemInfoLight = -13,
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemInfoDark = -14,
	
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemDisclosure = -15,
	
	UIMIU1507_Botsford_Bryan_InformationAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIU1507_Botsford_Bryan_InformationApp instances of
