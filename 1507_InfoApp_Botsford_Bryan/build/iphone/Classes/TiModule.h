...
/**
 The base class for all MIU1507_Botsford_Bryan_InformationApp modules
 */
...
/**
 MIU1507_Botsford_Bryan_InformationApp Platform calls this method on startup.
 */
-(void)startup;

/**
 MIU1507_Botsford_Bryan_InformationApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MIU1507_Botsford_Bryan_InformationApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MIU1507_Botsford_Bryan_InformationApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MIU1507_Botsford_Bryan_InformationApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
