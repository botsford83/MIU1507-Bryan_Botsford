...
@interface MIU1507_Botsford_Bryan_InformationAppObject : KrollCoverageObject {
#else
@interface MIU1507_Botsford_Bryan_InformationAppObject : KrollObject {
#endif
@private
...
extern NSString * MIU1507_Botsford_Bryan_InformationApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MIU1507_Botsford_Bryan_InformationAppObject *_miu1507_botsford_bryan_informationapp;
    KrollObject* console;
	BOOL shutdown;
