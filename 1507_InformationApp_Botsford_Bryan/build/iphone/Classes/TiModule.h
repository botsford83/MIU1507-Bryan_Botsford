...
/**
 The base class for all k1507_InformationApp_Botsford_Bryan modules
 */
...
/**
 k1507_InformationApp_Botsford_Bryan Platform calls this method on startup.
 */
-(void)startup;

/**
 k1507_InformationApp_Botsford_Bryan Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k1507_InformationApp_Botsford_Bryan Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k1507_InformationApp_Botsford_Bryan Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k1507_InformationApp_Botsford_Bryan Platform calls this method on resume.
 @param sender The sender of the event.
 */
