...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.k1507_informationapp_botsford_bryan._k1507_informationapp_botsford_bryan.imageloader" code:1 userInfo:errorDetail];
