...
// in simulator we redefine to format for k1507_InformationApp_Botsford_Bryan Developer console
...
{\
	NSString * exceptionName = [@"org.k1507_informationapp_botsford_bryan." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1507_informationapp_botsford_bryan";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1507_InformationApp_Botsford_BryanNativeItemNone = -1, 
	UIk1507_InformationApp_Botsford_BryanNativeItemSpinner = -2,
	UIk1507_InformationApp_Botsford_BryanNativeItemProgressBar = -3,
	
	UIk1507_InformationApp_Botsford_BryanNativeItemSlider = -4,
	UIk1507_InformationApp_Botsford_BryanNativeItemSwitch = -5,
	UIk1507_InformationApp_Botsford_BryanNativeItemMultiButton = -6,
	UIk1507_InformationApp_Botsford_BryanNativeItemSegmented = -7,
	
	UIk1507_InformationApp_Botsford_BryanNativeItemTextView = -8,
	UIk1507_InformationApp_Botsford_BryanNativeItemTextField = -9,
	UIk1507_InformationApp_Botsford_BryanNativeItemSearchBar = -10,
	
	UIk1507_InformationApp_Botsford_BryanNativeItemPicker = -11,
	UIk1507_InformationApp_Botsford_BryanNativeItemDatePicker = -12,
	
	UIk1507_InformationApp_Botsford_BryanNativeItemInfoLight = -13,
	UIk1507_InformationApp_Botsford_BryanNativeItemInfoDark = -14,
	
	UIk1507_InformationApp_Botsford_BryanNativeItemDisclosure = -15,
	
	UIk1507_InformationApp_Botsford_BryanNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1507_InformationApp_Botsford_Bryan instances of
