 ...
 * to send analytic data that can be viewed on the k1507_InformationApp_Botsford_Bryan Dashboard.
 *
 * For information on getting started with k1507_InformationApp_Botsford_Bryan Platform Services,
