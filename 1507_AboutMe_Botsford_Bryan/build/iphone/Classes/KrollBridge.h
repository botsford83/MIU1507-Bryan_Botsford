...
@interface k1507_AboutMe_Botsford_BryanObject : KrollCoverageObject {
#else
@interface k1507_AboutMe_Botsford_BryanObject : KrollObject {
#endif
@private
...
extern NSString * k1507_AboutMe_Botsford_Bryan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1507_AboutMe_Botsford_BryanObject *_k1507_aboutme_botsford_bryan;
    KrollObject* console;
	BOOL shutdown;
