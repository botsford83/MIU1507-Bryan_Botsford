...
//@interface k1507_AboutMe_Botsford_BryanObject : NSObject
//@end

@interface k1507_AboutMe_Botsford_BryanObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1507_AboutMe_Botsford_BryanObject class]])
		{
			for (NSString *key in [[(k1507_AboutMe_Botsford_BryanObject*)o modules] allKeys])
			{
