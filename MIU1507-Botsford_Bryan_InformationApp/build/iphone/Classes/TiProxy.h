...
//Rare exceptions to indicate a bug in the _miu1507_botsford_bryan_informationapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for MIU1507_Botsford_Bryan_InformationApp proxies.
 */
