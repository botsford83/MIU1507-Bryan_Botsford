...
//@interface MIU1507_Botsford_Bryan_InformationAppObject : NSObject
//@end

@interface MIU1507_Botsford_Bryan_InformationAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIU1507_Botsford_Bryan_InformationAppObject class]])
		{
			for (NSString *key in [[(MIU1507_Botsford_Bryan_InformationAppObject*)o modules] allKeys])
			{
