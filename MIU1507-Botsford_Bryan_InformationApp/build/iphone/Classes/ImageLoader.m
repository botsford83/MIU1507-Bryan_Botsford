...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.miu1507_botsford_bryan_informationapp._miu1507_botsford_bryan_informationapp.imageloader" code:1 userInfo:errorDetail];
