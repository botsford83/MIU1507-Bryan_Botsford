...
/**
 Base class for all MIU1507_Botsford_Bryan_InformationApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MIU1507_Botsford_Bryan_InformationApp view hierarchy (such as wrapped iOS UIViews) was touched.
