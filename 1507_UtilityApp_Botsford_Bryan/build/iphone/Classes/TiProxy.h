...
//Rare exceptions to indicate a bug in the _k1507_utilityapp_botsford_bryan code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1507_UtilityApp_Botsford_Bryan proxies.
 */
