...
@interface k1507_UtilityApp_Botsford_BryanObject : KrollCoverageObject {
#else
@interface k1507_UtilityApp_Botsford_BryanObject : KrollObject {
#endif
@private
...
extern NSString * k1507_UtilityApp_Botsford_Bryan$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1507_UtilityApp_Botsford_BryanObject *_k1507_utilityapp_botsford_bryan;
    KrollObject* console;
	BOOL shutdown;
