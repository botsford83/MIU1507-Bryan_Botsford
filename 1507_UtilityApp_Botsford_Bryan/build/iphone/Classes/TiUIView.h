...
/**
 Base class for all k1507_UtilityApp_Botsford_Bryan views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1507_UtilityApp_Botsford_Bryan view hierarchy (such as wrapped iOS UIViews) was touched.
